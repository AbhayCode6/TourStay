...
const sampleListings = [
...

  {
    title: "Beachfront Paradise",
    category: "pools",
    description: "Step out onto the sandy beach from this beachfront condo.",
    image: {
      filename: "listingimage",
...

  {
    title: "Rustic Cabin by the Lake",
    category: "mountains",
    description: "Cozy cabin perfect for fishing and kayaking.",
    image: {
      filename: "listingimage",
...

  {
    title: "Luxury Penthouse with City Views",
    category: "rooms",
    description: "Luxury penthouse apartment with stunning city views.",
    image: {
      filename: "listingimage",
...

  {
    title: "Ski-In/Ski-Out Chalet",
    category: "mountains",
    description: "Ski chalet located directly on the slopes.",
    image: {
      filename: "listingimage",
...

  {
    title: "Desert Oasis in Dubai",
    category: "trending",
    description: "Luxury desert villa with private pool.",
    image: {
      filename: "listingimage",
